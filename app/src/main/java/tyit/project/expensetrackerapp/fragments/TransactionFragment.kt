...
import tyit.project.expensetrackerapp.*
...
class TransactionFragment : Fragment() {
    ...
    private fun visibilityOptions (){
        typeOption = requireView().findViewById<Spinner>(R.id.typeSpinner)!!
        ...
        timeSpanOption = requireView().findViewById<Spinner>(R.id.timeSpanSpinner)!!
